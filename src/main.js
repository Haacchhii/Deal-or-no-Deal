...
function footer() {
  return `<footer class="site-footer"><span>${esc(catalog.name)}</span><p>${catalog.preview ? "Preview branding · Sample albums are labeled" : "A closer look at your next home."}</p><a href="#/units?tower=A">Explore the units <span aria-hidden="true">↗</span></a></footer>`;
}
function home() {
